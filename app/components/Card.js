...
function Card({product}){
    return (
        <div className="flex mx-2 rounded-lg xl:rounded-xl shadow-md overflow-hidden md:flex-col max-md:max-h-[12rem] md:max-w-sm "> 

            <Image src={product.images.find(img => img.priority === 1).url} alt={product.name}/>
